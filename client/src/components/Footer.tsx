    ...
    <footer className="mt-16 bg-black text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Bookmarko. All rights reserved.</p>
          <div className="mt-4 md:mt-0">
            <a href="https://github.com/fugitivexyz" className="text-gray-400 hover:text-white">
